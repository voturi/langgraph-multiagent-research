...
class ExecutionResult(BaseModel):
    ...
    @classmethod
    def success_result(cls, data: dict = None, execution_time: float = 0.0) -> 'ExecutionResult':
    ...
    @classmethod
    def error_result(cls, error_message: str, execution_time: float = 0.0) -> 'ExecutionResult':
        """Create error result"""
        return cls(
            success=False,
